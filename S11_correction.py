...
def low_band_switch_correction(ant_s11, temp_sw, f_in = np.zeros([0,1])):
	...
	# Paths
	root_path    = '/data5/edges/data/'
	data_path_15 = root_path + 'Receiver01_01_08_2018_040_to_200_MHz/15C/S11/InternalSwitch/'
	data_path_25 = root_path + 'Receiver01_01_08_2018_040_to_200_MHz/25C/S11/InternalSwitch/'
	data_path_35 = root_path + 'Receiver01_01_08_2018_040_to_200_MHz/35C/S11/InternalSwitch/'
...
def low_band_switch_correction_june_2016(ant_s11, f_in = np.zeros([0,1]),flow=50,fhigh=100, resistance_m=50.166, verification = 'no'):  
    home_folder = '/data5/edges/data/'
    path_folder     = home_folder +'Receiver01_2018_01_08_040_to_200_MHz/25C/S11/InternalSwitch/'#'Lowband3_October_2017_Recalibration/S11/25C/InternalSwitch01/'#'Receiver01_01_08_2018_040_to_200_MHz/25C/S11/InternalSwitch01/'##'Receiver1_25C_2019_04_10_040_to_200_MHz/25C/S11/InternalSwitch02/'#''Receiver03_2019_01_14_040_to_200_MHz/25C/S11/InternalSwitch01/'###'
	#path_folder_vna = home_folder + '/DATA/EDGES/calibration/receiver_calibration/calibration_june_2016/LNA/S11/raw/reference_attenuators/''Receiver03_2018_08_23_040_to_200_MHz/25C/S11/InternalSwitch01/'#'Lowband3_October_2017_Recalibration/S11/25C/InternalSwitch01/'# 


    o_sw_m, f = rc.s1p_read(path_folder + 'Open01.s1p')
    s_sw_m, f = rc.s1p_read(path_folder + 'Short01.s1p')
    l_sw_m, f = rc.s1p_read(path_folder + 'Match01.s1p')
...
def low_band_switch_correction_may_2019(ant_s11, f_in = np.zeros([0,1]),flow=50,fhigh=100, verification = 'no'):  
    home_folder = 'C:/EDGES/Receiver-data/'
    path_folder     = home_folder +'Receiver02_2018_09_24_040_to_200_MHz/25C/S11/InternalSwitch01/'#'Receiver1_25C_2019_04_10_040_to_200_MHz/25C/S11/InternalSwitch02/'#''Receiver03_2019_01_14_040_to_200_MHz/25C/S11/InternalSwitch01/'##'Lowband3_October_2017_Recalibration/S11/25C/InternalSwitch01/'##'
	#path_folder_vna = home_folder + '/DATA/EDGES/calibration/receiver_calibration/calibration_june_2016/LNA/S11/raw/reference_attenuators/''Receiver03_2018_08_23_040_to_200_MHz/25C/S11/InternalSwitch01/'#'Lowband3_October_2017_Recalibration/S11/25C/InternalSwitch01/'# 
